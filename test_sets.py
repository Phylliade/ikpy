...
third_arm_bounds_deg = ((-155., 120.), (-110., 105.), (-90., 90.), (7., 147), (-90, 90), (-90, 90), (-135, 40), (-90, 90), (-90, 90))
third_arm_bounds = tuple((float(i) * np.pi / 180, float(j) * np.pi / 180) for (i, j) in third_arm_bounds_deg)
