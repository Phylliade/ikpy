...
class creature(model.Model, creature_interface.CreatureInterface):
    """The creature class"""
    def __init__(self, creature_type, interface_type=None, move_duration=None, ik_regularization_parameter=None):
        ...
        model.Model.__init__(self, params, computation_method="hybrid", simplify=False, interface_type=interface_type, move_duration=move_duration, ik_regularization_parameter=ik_regularization_parameter)
